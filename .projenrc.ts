...
project.package?.addField('packageManager', 'pnpm@12.4.2')
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@24.13.5'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@types/node@24.13.5', '@types/ramda@0.32.0'],
      peerDeps: ['@babel/core@^8.0.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      copyrightYear: '2024',
      type: 'module',
      deps: ['@jest/globals@30.5.1', 'nock@14.0.17', 'tempy@3.2.0'],
      peerDeps: ['jest@^30.0.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@24.13.5'],
