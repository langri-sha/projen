...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-test@workspace:*', '@types/node@24.13.6'],
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@types/node@24.13.6', '@types/ramda@0.32.0'],
      peerDeps: ['@babel/core@^8.0.0'],
    },
  },
  subproject,
...
project.addSubproject(
  {
    ...
    package: {
      ...
      devDeps: ['@langri-sha/babel-preset@workspace:*', '@types/node@24.13.6'],
