...
test('drops optional members named beside an index signature', async () => {
  nock('https://www.schemastore.org')
    .get('/api/json/catalog.json')
    .reply(200, {
      $schema: 'https://json.schemastore.org/schema-catalog.json',
      ...
      schemas: [
        {
          name: 'Bagged',
          description: 'Bagged schema description',
          url: 'https://example.com/bagged.json',
        },
      ],
    })
