...
- Require vitest 5 as the peer dependency (filip.dupanovic@gmail.com)
...
- Migrate Tempy calls to v3 named exports (filip.dupanovic@gmail.com)
...
- chore(deps): update dependency vitest to v4 (email not defined)
- fix(deps): update dependency nock to v14 (email not defined)
