...
- Stop requiring consumers to install lint-staged (filip.dupanovic@gmail.com)
...
- Use lint-staged's bundled Configuration type instead of the removed @types/lint-staged stub (filip.dupanovic@gmail.com)
