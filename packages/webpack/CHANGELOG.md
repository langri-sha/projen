...
<!-- This log was last generated on Fri, 14 Aug 2026 22:56:34 GMT and should not be manually modified. -->

<!-- Start content -->

## 0.6.1

Fri, 14 Aug 2026 22:56:34 GMT
...
- fix(deps): update dependency webpack-dev-server to v5.2.1 [security] (email not defined)
- fix(deps): update dependency webpack-dev-server to v5.2.3 (email not defined)
...
- feat(webpack): Add `webpack-subresource-integrity` (filip.dupanovic@gmail.com)
...
- feat(webpack): Manage package with projen (filip.dupanovic@gmail.com)
