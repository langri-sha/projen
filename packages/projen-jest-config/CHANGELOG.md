...
- Stop requiring consumers to install Jest (filip.dupanovic@gmail.com)
...
- Update dependency serialize-javascript to v7.1.1
...
- Update dependency jest to v30 (email not defined)
...
- Correct the malformed jest peer range, which pnpm 11 rejects (filip.dupanovic@gmail.com)
...
- fix(deps): update dependency serialize-javascript to v7 (email not defined)
